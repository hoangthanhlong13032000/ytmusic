...
import htlong.learn.youtube.databinding.ItemSuggestBinding
import htlong.learn.youtube.utils.Utils.getMDrawable

class SuggestView(context: Context?, attrs: AttributeSet? = null) : LinearLayout(context, attrs) {
    var binding = ItemSuggestBinding.inflate(LayoutInflater.from(context), this)
